...
namespace DemoAPIScalarGalaxy\Core\Attributes;
...
use DemoAPIScalarGalaxy\Core\Conversion\ListOf;
use DemoAPIScalarGalaxy\Core\Conversion\MapOf;
...
class Required
{
    ...
    public function __construct(
        ...
        if (null !== $enum) {
            $type ??= $enum instanceof Converter
                ? $enum
                : EnumOf::fromBackedEnum($enum);
        }
