...
use DemoAPIScalarGalaxy\Planets\Planet\Atmosphere;
use DemoAPIScalarGalaxy\Planets\Planet\PhysicalProperties;
use DemoAPIScalarGalaxy\Planets\Planet\Type;

/**
 * A planet in the Scalar Galaxy.
 *
 * @phpstan-import-type AtmosphereShape from \DemoAPIScalarGalaxy\Planets\Planet\Atmosphere
 * @phpstan-import-type UserShape from \DemoAPIScalarGalaxy\Authentication\User
 * @phpstan-import-type PhysicalPropertiesShape from \DemoAPIScalarGalaxy\Planets\Planet\PhysicalProperties
 * @phpstan-import-type SatelliteShape from \DemoAPIScalarGalaxy\Planets\Satellite
 *
 * @phpstan-type PlanetShape = array{
 *   id: int,
 *   name: string,
 ...
 * }
 */
final class Planet implements BaseModel
{
    /** @use SdkModel<PlanetShape> */
    use SdkModel;
    ...
    /**
     * `new Planet()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Planet::with(id: ..., name: ..., type: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Planet)->withID(...)->withName(...)->withType(...)
     * ```
     */
