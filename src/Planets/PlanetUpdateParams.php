...
use DemoAPIScalarGalaxy\Planets\PlanetUpdateParams\Atmosphere;
use DemoAPIScalarGalaxy\Planets\PlanetUpdateParams\PhysicalProperties;
use DemoAPIScalarGalaxy\Planets\PlanetUpdateParams\Type;

/**
 * Sometimes you make mistakes, that's fine. No worries, you can update all planets.
 *
 * @see DemoAPIScalarGalaxy\Services\PlanetsService::update()
 *
 * @phpstan-import-type AtmosphereShape from \DemoAPIScalarGalaxy\Planets\PlanetUpdateParams\Atmosphere
 * @phpstan-import-type UserShape from \DemoAPIScalarGalaxy\Authentication\User
 * @phpstan-import-type PhysicalPropertiesShape from \DemoAPIScalarGalaxy\Planets\PlanetUpdateParams\PhysicalProperties
 * @phpstan-import-type SatelliteShape from \DemoAPIScalarGalaxy\Planets\Satellite
 *
 * @phpstan-type PlanetUpdateParamsShape = array{
 *   name: string,
 ...
 * }
 */
final class PlanetUpdateParams implements BaseModel
{
    /** @use SdkModel<PlanetUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PlanetUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PlanetUpdateParams::with(name: ..., type: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PlanetUpdateParams)->withName(...)->withType(...)
     * ```
     */
